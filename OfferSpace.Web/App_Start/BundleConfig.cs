...
namespace OfferSpace.Web
{
  public class BundleConfig
  {
    ...
    {
      bundles.Add(new ScriptBundle("~/bundles/user-profile-page/js").Include(
        "~/Scripts/UserProfilePage/user-profile-page.js"
      ));
      ...
      bundles.Add(new StyleBundle("~/ContentUserProfilePage/css").Include(
        "~/Content/UserProfilePage/bootstrap.min.css",
        "~/Content/UserProfilePage/user-profile-page.css"
      ));
